...
> **Hands-on Quick Start** - Create a working trading project with MetaTrader 4 and PyMT4 from scratch.
...
account = MT4Account(user=user, password=password, host=grpc_server, api_key=api_key)
