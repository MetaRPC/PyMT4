...
* `quote(...)` → see [quote.md](../API_Reference/MT4Account.md)
* `quote_many(...)` → see [quote_many.md](../API_Reference/MT4Account.md)
* `quote_history(...)` → see [quote_history.md](../API_Reference/MT4Account.md)
* `symbols(...)` → see [symbols.md](../API_Reference/MT4Account.md)
* `symbol_params_many(...)` → see [symbol_params_many.md](../API_Reference/MT4Account.md)
* `tick_value_with_size(...)` → see [tick_value_with_size.md](../API_Reference/MT4Account.md)
* `opened_orders(...)` → see [opened_orders.md](../API_Reference/MT4Account.md)
* `opened_orders_tickets(...)` → see [opened_orders_tickets.md](../API_Reference/MT4Account.md)
* `order_send(...)` → see [order_send.md](../API_Reference/MT4Account.md)
* `order_modify(...)` → see [order_modify.md](../API_Reference/MT4Account.md)
* `order_close_delete(...)` → see [order_close_delete.md](../API_Reference/MT4Account.md)
* `order_close_by(...)` → see [order_close_by.md](../API_Reference/MT4Account.md)
...
* `account_summary(...)` → see [account_summary.md](../API_Reference/MT4Account.md)
