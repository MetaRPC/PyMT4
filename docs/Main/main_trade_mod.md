...
- `quote(...)` → low‑level: [quote.md](../API_Reference/MT4Account.md)
...
- `close_partial(...)` → low‑level: [order_close_delete.md](../API_Reference/MT4Account.md)
- `sell_market(...)` → low‑level: [order_send.md](../API_Reference/MT4Account.md)
- `close_by(...)` → low‑level: [order_close_by.md](../API_Reference/MT4Account.md)
- `opened_orders(...)` → low‑level: [opened_orders.md](../API_Reference/MT4Account.md)
