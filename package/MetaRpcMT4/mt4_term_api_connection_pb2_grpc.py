...
class ConnectionStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ConnectState = channel.unary_unary(
                ...
                request_serializer=mt4__term__api__connection__pb2.ConnectStateRequest.SerializeToString,
                response_deserializer=mt4__term__api__connection__pb2.ConnectStateReply.FromString,
                )
        self.OnConnectState = channel.unary_stream(
                '/mt4_term_api.Connection/OnConnectState',
                request_serializer=mt4__term__api__connection__pb2.OnConnectStateRequest.SerializeToString,
                response_deserializer=mt4__term__api__connection__pb2.OnConnectStateReply.FromString,
                )
        self.ConnectionStatus = channel.unary_unary(
                '/mt4_term_api.Connection/ConnectionStatus',
                request_serializer=mt4__term__api__connection__pb2.ConnectionStatusRequest.SerializeToString,
                response_deserializer=mt4__term__api__connection__pb2.ConnectionStatusReply.FromString,
                )
        ...
        self.ConnectByToken = channel.unary_unary(
                ...
                request_serializer=mt4__term__api__connection__pb2.ConnectByTokenRequest.SerializeToString,
                response_deserializer=mt4__term__api__connection__pb2.ConnectExReply.FromString,
                )
...
def add_ConnectionServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ConnectState': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=mt4__term__api__connection__pb2.ConnectStateRequest.FromString,
                    response_serializer=mt4__term__api__connection__pb2.ConnectStateReply.SerializeToString,
            ),
            'OnConnectState': grpc.unary_stream_rpc_method_handler(
                    servicer.OnConnectState,
                    request_deserializer=mt4__term__api__connection__pb2.OnConnectStateRequest.FromString,
                    response_serializer=mt4__term__api__connection__pb2.OnConnectStateReply.SerializeToString,
            ),
            'ConnectionStatus': grpc.unary_unary_rpc_method_handler(
                    servicer.ConnectionStatus,
                    request_deserializer=mt4__term__api__connection__pb2.ConnectionStatusRequest.FromString,
                    response_serializer=mt4__term__api__connection__pb2.ConnectionStatusReply.SerializeToString,
            ),
            ...
            'ConnectByToken': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=mt4__term__api__connection__pb2.ConnectByTokenRequest.FromString,
                    response_serializer=mt4__term__api__connection__pb2.ConnectExReply.SerializeToString,
            ),
...
class Connection(object):
    ...
    def ConnectState(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/mt4_term_api.Connection/ConnectState',
            mt4__term__api__connection__pb2.ConnectStateRequest.SerializeToString,
            mt4__term__api__connection__pb2.ConnectStateReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def OnConnectState(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/mt4_term_api.Connection/OnConnectState',
            mt4__term__api__connection__pb2.OnConnectStateRequest.SerializeToString,
            mt4__term__api__connection__pb2.OnConnectStateReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def ConnectionStatus(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/mt4_term_api.Connection/ConnectionStatus',
            mt4__term__api__connection__pb2.ConnectionStatusRequest.SerializeToString,
            mt4__term__api__connection__pb2.ConnectionStatusReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def ConnectByToken(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/mt4_term_api.Connection/ConnectByToken',
            mt4__term__api__connection__pb2.ConnectByTokenRequest.SerializeToString,
            mt4__term__api__connection__pb2.ConnectExReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
...
class LogsStub(object):
    ...
    def __init__(self, channel):
        ...
        self.OnJournal = channel.unary_stream(
                ...
                request_serializer=mt4__term__api__connection__pb2.OnJournalRequest.SerializeToString,
                response_deserializer=mt4__term__api__connection__pb2.OnJournalReply.FromString,
                )
...
def add_LogsServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'OnJournal': grpc.unary_stream_rpc_method_handler(
                    servicer.OnJournal,
                    request_deserializer=mt4__term__api__connection__pb2.OnJournalRequest.FromString,
                    response_serializer=mt4__term__api__connection__pb2.OnJournalReply.SerializeToString,
            ),
...
class Logs(object):
    ...
    def OnJournal(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/mt4_term_api.Logs/OnJournal',
            mt4__term__api__connection__pb2.OnJournalRequest.SerializeToString,
            mt4__term__api__connection__pb2.OnJournalReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def OnExperts(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/mt4_term_api.Logs/OnExperts',
            mt4__term__api__connection__pb2.OnJournalRequest.SerializeToString,
            mt4__term__api__connection__pb2.OnJournalReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
